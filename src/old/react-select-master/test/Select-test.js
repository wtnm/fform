...
describe('Select', () => {
	...
	describe('with simple options', () => {
		...
		describe('pressing escape', () => {
			...
			it('should call _onChange with a empty value', () => {
	...
	describe('with values as numbers', () => {
		...
		it('calls _onChange with the new value as a number', () => {
		...
		describe('with multi=true', () => {
			...
			it('calls _onChange with the correct value when 1 option is selected', () => {
			...
			it('calls _onChange with the correct values when multiple options are selected', () => {
	...
	describe('with values as booleans', () => {
		...
		it('calls _onChange with the new value as a boolean', () => {
			clickArrowToOpen();
			pressDown();
			pressEnterToAccept();
		...
		describe('with multi=true', () => {
			...
			it('calls _onChange with the correct value when true option is deselected', () => {
	...
	describe('with allowCreate=true', () => {
		...
		it('fires an _onChange with the new value when selecting the Add option', () => {
		...
		it('allows updating the options with a new label, following the _onChange', () => {
	...
	describe('with multi-select', () => {
		...
		describe('when using the option value object', () => {
			...
			it('selects an additional option', () => {
				...
				typeSearchText('th');
				onChange.reset();  // Ignore previous _onChange calls
				pressEnterToAccept();
	...
	describe('with multi=true and clearable=true', () => {
		...
		it('calls _onChange with an empty list when cleared', () => {
	...
	describe('with multi=true and searchable=false', () => {
		...
		it('calls _onChange when each option is selected', () => {
	...
	describe('with _props', () => {
		...
		describe('clearable=true', () => {
			...
			describe('on clicking `clear` with a custom resetValue', () => {
				...
				it('calls _onChange with a custom resetValue', () => {
					TestUtils.Simulate.mouseDown(ReactDOM.findDOMNode(instance).querySelector('.Select-clear'), { button: 0 });
