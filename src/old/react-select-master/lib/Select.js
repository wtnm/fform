...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		onChange: _react2['default'].PropTypes.func, // _onChange handler: function (newValue) {}
		...
		simpleValue: _react2['default'].PropTypes.bool, // pass the value to _onChange as a simple value (legacy pre 1.0 mode), defaults to false
