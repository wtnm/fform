"use strict";
var __$_0__='length',__$_1__='isUndefined',__$_2__='push2array',__$_3__='forEach',__$_4__='getIn',__$_5__='concat',__$_6__='additionalItems',__$_7__='objKeys',__$_8__='replace',__$_9__='isArray',__$_10__='value',__$_11__='merge',__$_12__='makeSlice',__$_13__='oneOf',__$_14__='defaultValues',__$_15__='update',__$_16__='current',__$_17__='slice',__$_18__='isObject',__$_19__='path',__$_20__='moveArrayElems',__$_21__='setIn',__$_22__='isMergeable',__$_23__='setStatus',__$_24__='properties',__$_25__='indexOf',__$_26__='fData',__$_27__='macros',__$_28__='hasOwnProperty',__$_29__='setValue',__$_30__='minItems',__$_31__='hasIn',__$_32__='getOwnPropertySymbols',__$_33__='items',__$_34__='default',__$_35__='dataMap',__$_36__='toString',__$_37__='schemaPart';
...
var __rest = this && this.__rest || function (s, e) {
    ...
    }if (s != null && typeof Object[__$_32__]  === "function") for (var i = 0, p = Object[__$_32__] (s); i < p[__$_0__] ; i++) {
...
function getBindedMaps2update(branch) {
    ...
    var maps2disable = commonLib_1[__$_4__] (branch, SymDataMapTree, SymData) || [];
    ...
    commonLib_1[__$_7__] (branch)[__$_3__] (function (key) {
        var result = void 0;
        if (branch[key]) result = getBindedMaps2update(branch[key], path[__$_5__] (key));
        commonLib_1[__$_2__] (maps2disable, result.maps2disable);
        commonLib_1[__$_2__] (maps2enable, result.maps2enable);
    });
...
Macros.array = function (state, schema, UPDATABLE_object, item) {
    ...
    if (commonLib_2[__$_9__] (item[__$_10__] )) {
        var mergeArrayObj = [];
        var replaceArrayObj = {};
        for (var i = 0; i < item[__$_10__] .length; i++) {
            mergeArrayObj[length + i] = item[__$_10__] [i];
            replaceArrayObj[length + i] = commonLib_1[__$_4__] (item[__$_8__] , i);
        }
        mergeArrayObj[__$_0__]  = length + item[__$_10__] .length;
        return updateCurrentRecursively(state, schema, UPDATABLE_object, mergeArrayObj, replaceArrayObj, path);
    } else {
        length += item[__$_10__]  || 1;
        return updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(path, [__$_0__] , length));
    }
};
Macros.arrayItem = function (state, schema, UPDATABLE_object, item) {
    var path = item[__$_19__] ;
    var op = item.op;
    var opVal = item[__$_10__]  || 0;
    ...
    var currentObject = {};
    var updObj = [];
    updObj[0] = commonLib_1[__$_4__] (UPDATABLE_object[__$_15__] , path);
    updObj[1] = commonLib_1[__$_4__] (UPDATABLE_object[__$_15__] , SymData, 'current', path);
    updObj[2] = commonLib_1[__$_4__] (UPDATABLE_object[__$_8__] , path);
    updObj[3] = commonLib_1[__$_4__] (UPDATABLE_object[__$_8__] , SymData, 'current', path);

    var _loop = function _loop(i) {
        stateObject[i] = commonLib_1[__$_4__] (state, path, i);
        arrayItems[i] = stateObject[i][SymData].arrayItem; 
        
        currentObject[i] = commonLib_1[__$_4__] (state, SymData, 'current', path, i);
...
Macros.switch = function (state, schema, UPDATABLE_object, item) {
    ...
    var switches = commonLib_1[__$_12__] (keyPath, item[__$_10__] );
...
Macros[__$_23__]  = function (state, schema, UPDATABLE_object, item) {
    ...
    var value = prevVal + item[__$_10__] ;
...
Macros.setCurrent = function (state, schema, UPDATABLE_object, item) {
    return updateCurrentRecursively(state, schema, UPDATABLE_object, item[__$_10__] , item[__$_8__] , item[__$_19__] , item.setOneOf);
};
Macros.setOneOf = function (state, schema, UPDATABLE_object, item) {
    var oldOneOf = commonLib_1[__$_4__] (state, item[__$_19__] , SymData, 'oneOf');
    if (oldOneOf == item[__$_10__] ) {
        if (!commonLib_2[__$_1__] (item[__$_29__] )) state = updateCurrentRecursively(state, schema, UPDATABLE_object, item[__$_29__] , false, item[__$_19__] );
        return state;
    }
    ...
    if (commonLib_2[__$_1__] (newItem[__$_29__] )) {
        state = mergeStatePROCEDURE(state, UPDATABLE_object);
        newItem[__$_29__]  = commonLib_1[__$_4__] (state, SymData, 'current', item[__$_19__] );
    }
...
var trueIfLength = function trueIfLength(length) {
    return function (path) {
        return commonLib_1[__$_4__] (path, 'length') === length;
    };
};
...
function recursivelyUpdate(state, schema, UPDATABLE_object, item) {
    var keys = branchKeys(commonLib_1[__$_4__] (state, item[__$_19__] ));
    if (item[__$_10__]  == SymReset && item[SymData][0] == 'status') {
        var i = Object.assign({}, item);
        i[__$_10__]  = item[SymData][1] == 'untouched' ? keys[__$_0__]  : 0;
...
function oneOfFromState(state) {
    return function (path) {
        var s = commonLib_1[__$_4__] (commonLib_2.isFunction(state) ? state() : state, path, SymData);
        return { oneOf: commonLib_1[__$_4__] (s, 'oneOf'), type: commonLib_1[__$_4__] (s, 'fData', 'type') };
    };
}
...
function oneOfStructure(state, path) {
    ...
    var result = {};
    var tmp = result;
    commonLib_1[__$_21__] (tmp, commonLib_1[__$_4__] (state, SymData, 'oneOf'), SymData, 'oneOf');
    commonLib_1[__$_21__] (tmp, commonLib_1[__$_4__] (state, SymData, 'fData', 'type'), SymData, 'type');
    for (var i = 0; i < path[__$_0__] ; i++) {
        if (commonLib_2[__$_1__] (path[i]) || path[i] === '') continue;
        tmp[path[i]] = {};
        tmp = tmp[path[i]];
        state = commonLib_1[__$_4__] (state, path[i]);
        commonLib_1[__$_21__] (tmp, commonLib_1[__$_4__] (state, SymData, 'oneOf'), SymData, 'oneOf');
        commonLib_1[__$_21__] (tmp, commonLib_1[__$_4__] (state, SymData, 'fData', 'type'), SymData, 'type');
    }
    
    var fn = function fn(path, oneOf) {
        return commonLib_2[__$_1__] (oneOf) ? commonLib_1[__$_4__] (result, path, SymData) : commonLib_1[__$_21__] (result, oneOf, path, SymData);
    };
    fn._canSet = true;
    return fn;
}
...
function branchKeys(branch) {
    var keys = [];
    if (branch[SymData][__$_26__] .type == 'array') for (var j = 0; j < commonLib_1[__$_4__] (branch, SymData, 'length'); j++) {
        keys.push(j[__$_36__] ());
...
function getSchemaPart(schema, path, getOneOf, fullOneOf) {
    function getArrayItemSchemaPart(index, schemaPart) {
        var items = [];
        if (schemaPart[__$_33__] ) {
            if (!commonLib_2[__$_9__] (schemaPart[__$_33__] )) return schemaPart[__$_33__] ;else items = schemaPart[__$_33__] ;
        }
    ...
    function getSchemaByRef(schema, $ref) {
        ...
        if ($ref[0] == '#') return commonLib_1[__$_4__] (schema, path); 
...
var arrayStart = commonLib_1.memoize(function (schemaPart) {
    if (!commonLib_2[__$_9__] (schemaPart[__$_33__] )) return 0;
    if (schemaPart[__$_6__]  === false) return schemaPart[__$_33__] .length;
    if (_typeof(schemaPart[__$_6__] ) === 'object') return schemaPart[__$_33__] .length;
    if (schemaPart[__$_33__] .length == 0) return 0;
    return schemaPart[__$_33__] .length - 1;
});
...
var getEnumOptions = function getEnumOptions(schemaPart) {
    ...
    return schemaPart.enum.map(function (value, i) {
        return commonLib_2[__$_18__] (exten[i]) ? commonLib_1[__$_11__] (exten[i], { value: value }) : { value: value, label: exten[i] || value };
    });
};
...
var makeDataStorage = commonLib_1.memoize(function (schemaPart, oneOf, type, value) {
    ...
    result[__$_26__] .title = schemaPart.title;
    result[__$_26__] .placeholder = schemaPart.ff_placeholder;
    result[__$_26__] .enum = getEnumOptions(schemaPart);
    if (isSchemaSelfManaged(schemaPart, type)) result[__$_10__]  = commonLib_2[__$_1__] (value) ? schemaPart[__$_34__]  : value;else delete result[__$_10__] ;
    var untouched = 1;
    if (type == 'array') {
        result[__$_0__]  = commonLib_1[__$_4__] (value, 'length') || 0;
        if (!commonLib_2[__$_1__] (schemaPart[__$_30__] ) && result[__$_0__]  < schemaPart[__$_30__] ) result[__$_0__]  = schemaPart[__$_30__] ;
...
function getUniqKey() {
    return Date.now()[__$_36__] (36) + Math.random()[__$_36__] (36);
}
function makeStateBranch(schema, getNSetOneOf) {
    ...
    var _findOneOf = findOneOf(schemaPartsOneOf, value, currentOneOf),
        schemaPart = _findOneOf[__$_37__] ,
    ...
    if (!commonLib_2[__$_1__] (currentOneOf) && currentOneOf != oneOf) {
        ...
        value = schemaPartsOneOf[currentOneOf][__$_34__] ; 
        var tmp = findOneOf(schemaPartsOneOf, value, currentOneOf);
        schemaPart = tmp[__$_37__] ;
        oneOf = tmp[__$_13__] ;
        type = tmp.type;
    }
    commonLib_1[__$_2__] (dataMapObjects, normalizeDataMap(schemaPart.ff_dataMap || [], path));
    ...
    if (result[SymData][__$_28__] ('value')) defaultValues = result[SymData][__$_10__] ;else {
        if (type == 'array') {
            defaultValues = [];
            defaultValues[__$_0__]  = result[SymData][__$_0__] ;
            for (var i = 0; i < defaultValues[__$_0__] ; i++) {
                var _makeStateBranch = makeStateBranch(schema, getNSetOneOf, path[__$_5__] (i), commonLib_1[__$_4__] (commonLib_2[__$_1__] (value) ? schemaPart[__$_34__]  : value, i)),
                    branch = _makeStateBranch.state,
                    dataMap = _makeStateBranch[__$_35__] ,
                    dValue = _makeStateBranch[__$_14__] ;

                defaultValues[i] = dValue;
                commonLib_1[__$_2__] (dataMapObjects, dataMap);
                ...
                branch = commonLib_1[__$_11__] (branch, _defineProperty({}, SymData, { params: getUniqKey() }));
                result[i] = branch;
            }
        } else if (type == 'object') {
            defaultValues = {};
            ...
            commonLib_1[__$_7__] (schemaPart[__$_24__]  || {})[__$_3__] (function (field) {
                var _makeStateBranch2 = makeStateBranch(schema, getNSetOneOf, path[__$_5__] (field), value && value[field]),
                    ...
                    dataMap = _makeStateBranch2[__$_35__] ,
...
var makeStateFromSchema = commonLib_1.memoize(function (schema) {
    var _makeStateBranch3 = makeStateBranch(schema, oneOfStructure({}, [])),
        ...
        _makeStateBranch3$dat = _makeStateBranch3[__$_35__] ,
    ...
    state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate([], ['inital'], commonLib_1[__$_4__] (state, SymData, 'current')));
    state = mergeStatePROCEDURE(state, UPDATABLE_object);
    return state;
});
...
function setDataMapInState(state, schema, dataMaps) {
    ...
    dataMaps[__$_3__] (function (dataMap) {
        ...
        normalizeUpdate({ path: emitterPath.join('/') + '/' + dataMap.from, to: normalizePath(dataMap.to, emitterPath), value: dataMap.action }, state)[__$_3__] (function (NdataMap) {
            ...
            if (commonLib_1[__$_4__] (state, NdataMap[__$_19__] )) commonLib_1[__$_21__] (UPDATABLE_object[__$_15__] , unset ? undefined : NdataMap[__$_10__] , NdataMap[__$_19__] , SymDataMapTree, NdataMap[SymData], SymDataMap, relTo);
            if (!unset) {
                executeDataMapsPROCEDURE(state, schema, UPDATABLE_object, commonLib_1[__$_12__] (relTo, NdataMap[__$_10__] ), makeNUpdate(NdataMap[__$_19__] , NdataMap[SymData], commonLib_1[__$_4__] (state, NdataMap[__$_19__] , SymData, NdataMap[SymData])));
                if (!bindMap2emitter && relativePath(emitterPath, NdataMap[__$_19__] )[0] != '.') bindMap2emitter = true;
            }
            state = mergeStatePROCEDURE(state, UPDATABLE_object);
        });
        if (bindMap2emitter) {
            var emitterBranch = commonLib_1[__$_4__] (state, emitterPath);
            if (emitterBranch) {
                var bindedMaps = commonLib_1[__$_4__] (emitterBranch, SymDataMapTree, SymData) || [];
...
function isArrayCanAdd(schemaPart, length) {
    ...
    var minItems = schemaPart[__$_30__]  || 0;
...
function isSelfManaged(state) {
    ...
    return commonLib_1[__$_31__] .apply(commonLib_1, [state][__$_5__] (pathes, [SymData, 'value']));
}
exports.isSelfManaged = isSelfManaged;
function isSchemaSelfManaged(schemaPart, type) {
    return type !== 'array' && type !== 'object' || commonLib_1[__$_31__] (schemaPart, 'ff_managed');
}
...
function findOneOf(oneOfShemas, value, currentOneOf) {
    ...
    for (var k = 0; k < oneOfKeys[__$_0__] ; k++) {
        ...
        var checkValue = commonLib_2[__$_1__] (value) ? (defaultUsed = true) && oneOfShemas[oneOf][__$_34__]  : value;
        ...
        }if (defaultUsed && !commonLib_2[__$_1__] (oneOfShemas[oneOf][__$_34__] )) throw new Error('Type of schema.default is not supported by schema.type');
    }
    return {};
}
function updateCurrentRecursively(state, schema, UPDATABLE_object, value, replace) {
    ...
    if (value === SymReset) value = commonLib_1[__$_4__] (state, SymData, 'inital', track);
    if (value === SymClear) value = commonLib_1[__$_4__] (getDefaultFromSchema(schema), track);
    if (commonLib_1[__$_4__] (state, SymData, 'current', track) === value && !commonLib_1[__$_31__] (UPDATABLE_object[__$_15__] , SymData, 'current', track)) return state;
    var branch = commonLib_1[__$_4__] (state, track);
    
    if (!branch) {
        if (track[track[__$_0__]  - 1] == 'length') {
            
            var topPath = track[__$_17__] (0, -1);
            var topBranch = commonLib_1[__$_4__] (state, topPath);
    ...
    if (!types[branch[SymData][__$_26__] .type || 'any'](value)) {
        ...
        var _findOneOf2 = findOneOf(getSchemaPart(schema, track, oneOfFromState(state), true), value, commonLib_2[__$_1__] (setOneOf) ? branch[SymData][__$_13__]  : setOneOf),
            schemaPart = _findOneOf2[__$_37__] ,
            oneOf = _findOneOf2[__$_13__] ,
            type = _findOneOf2.type;

        if (schemaPart) {
            return updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(track, [__$_13__] , oneOf, false, { type: type, setValue: value }));
            
        } else console.warn('Type not found in path [' + track.join('/') + ']');
    }
    if (isSelfManaged(branch)) {
        
        state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(track, [__$_10__] , value, replace));
    } else {
        if (commonLib_2[__$_22__] (value)) {
            
            if (branch[SymData][__$_26__] .type == 'array' && !commonLib_2[__$_1__] (value[__$_0__] )) state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(track, [__$_0__] , value[__$_0__] ));
            commonLib_1[__$_7__] (value)[__$_3__] (function (key) {
                state = updateCurrentRecursively(state, schema, UPDATABLE_object, value[key], commonLib_1[__$_4__] (replace, key), track[__$_5__] (key));
            });
        }
    }
    return state;
...
function getUpdValue(states) {
    ...
    for (var i = 0; i < states[__$_0__] ; i++) {
        if (commonLib_1[__$_31__] .apply(commonLib_1, [states[i]][__$_5__] (pathes))) return commonLib_1[__$_4__] .apply(commonLib_1, [states[i]][__$_5__] (pathes));
    }
}
exports.getUpdValue = getUpdValue;
function splitValuePROCEDURE(state, schema, UPDATABLE_object, item) {
    var itemValue = item[__$_10__] ,
        path = item[__$_19__] ,
        replace = item[__$_8__] ;

    var keyPath = item[SymData] || [];
    if (keyPath[__$_0__]  == 0) {
        var value = itemValue[__$_10__] ,
        ...
        ['value', 'status', 'length', 'oneOf'][__$_3__] (function (key) {
            if (commonLib_1[__$_31__] (itemValue, key)) state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(path, [key], itemValue[key], commonLib_1[__$_4__] (replace, key)));
        });
        ...
        commonLib_1[__$_7__] (itemValue)[__$_3__] (function (key) {
            state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate(path, keyPath[__$_5__] (key), itemValue[key], commonLib_1[__$_4__] (replace, key)));
        });
    }
    return state;
}
...
function mergeStatePROCEDURE(state, UPDATABLE_object) {
    state = commonLib_1[__$_11__] (state, UPDATABLE_object[__$_15__] , { replace: UPDATABLE_object[__$_8__]  });
    UPDATABLE_object[__$_15__]  = {};
    UPDATABLE_object[__$_8__]  = {};
    return state;
}
...
function updateStatePROCEDURE(state, schema, UPDATABLE_object, item) {
    var update = UPDATABLE_object[__$_15__] ,
        replace_UPDATABLE = UPDATABLE_object[__$_8__] ;
    ...
    if (path[__$_0__]  == 0 && keyPath[0] == 'inital') {
        ...
        if (commonLib_2[__$_18__] (value) && (keyPath[__$_0__]  == 0 && (commonLib_1[__$_31__] (value, 'value') || commonLib_1[__$_31__] (value, 'status') || commonLib_1[__$_31__] (value, 'length') || commonLib_1[__$_31__] (value, 'oneOf')) || keyPath[__$_0__]  == 1 && keyPath[0] == 'status')) return splitValuePROCEDURE(state, schema, UPDATABLE_object, item);
        var branch = commonLib_1[__$_4__] (state, path);
        if (!commonLib_2[__$_18__] (branch)) return state; 
        if (keyPath[0] == 'value' && !commonLib_1[__$_31__] (branch, SymData, 'value')) 
        ...
        if (keyPath[0] == 'value') {
            ...
            state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate([], commonLib_1[__$_2__] ([__$_16__] , path, keyPath[__$_17__] (1)), value, replace));
        } else if (keyPath[0] == 'length') {
            
            state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate([], commonLib_1[__$_2__] ([__$_16__] , path, keyPath), value, replace));
            ...
            for (var i = start; i < end; i++) {
                ...
                var _makeStateBranch4 = makeStateBranch(schema, oneOfStateFn, elemPath),
                    ...
                    _makeStateBranch4$dat = _makeStateBranch4[__$_35__] ,
                ...
                state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate([], commonLib_1[__$_2__] ([__$_16__] , elemPath), defaultValues, true));
                
                commonLib_1[__$_2__] (maps2enable, _dataMap);
            ...
            for (var _i = end; _i < start; _i++) {
                ...
                commonLib_1[__$_2__] (maps2disable, commonLib_1[__$_4__] (state, _elemPath, SymDataMapTree, SymData) || []);
            ...
            var oldBranch = commonLib_1[__$_4__] (state, path);
            var oldOneOf = commonLib_1[__$_4__] (oldBranch, SymData, 'oneOf') || 0;
            var newOneOf = commonLib_1[__$_4__] (UPDATABLE_object[__$_15__] , path, SymData, 'oneOf');
            if (oldOneOf != newOneOf || item.type && item.type != commonLib_1[__$_4__] (oldBranch, SymData, 'fData', 'type')) {
                setIfNotDeeper(UPDATABLE_object, SymReset, 'forceCheck', item[__$_19__] );
                state = mergeStatePROCEDURE(state, UPDATABLE_object);
                state = setDataMapInState(state, schema, commonLib_1[__$_4__] (state, path, SymDataMapTree, SymData) || [], true);
                ...
                var _makeStateBranch5 = makeStateBranch(schema, oneOfStructure(state, path), path, item[__$_29__] ),
                    ...
                    _makeStateBranch5$dat = _makeStateBranch5[__$_35__] ,
                ...
                if (path[__$_0__] ) {
                    ...
                    ['invalid', 'dirty', 'pending'][__$_3__] (function (key) {
                        var oldStatusValue = commonLib_1[__$_4__] (oldBranch, SymData, 'status', key);
                        var newStatusValue = commonLib_1[__$_4__] (_branch2, SymData, 'status', key);
                    ...
                    var arrayOfRequired = commonLib_1[__$_4__] (state, topPath, SymData, 'fData', 'required');
                    arrayOfRequired = commonLib_2[__$_9__] (arrayOfRequired) && arrayOfRequired[__$_0__]  && arrayOfRequired;
                ...
                if (commonLib_1[__$_4__] (oldBranch, SymData, 'status', 'untouched') == 0) _branch2 = commonLib_1[__$_11__] (_branch2, _defineProperty({}, SymData, { status: { untouched: 0 } })); 
                ...
                if (commonLib_1[__$_4__] (_branch2, SymData, 'status', 'untouched') == 0) state = Macros.switch(state, schema, UPDATABLE_object, makeNUpdate(path, ['status', 'untouched'], 0));
                state = updateStatePROCEDURE(state, schema, UPDATABLE_object, makeNUpdate([], commonLib_1[__$_2__] ([__$_16__] , path), defaultValues, true));
            }
        }
    }
    
    var dataMap = commonLib_1[__$_4__] (state, path, SymDataMapTree);
    ...
    function recursivelyExecuteDataMaps(dataMap, value, replace) {
        ...
        commonLib_2[__$_22__] (value) && commonLib_1[__$_7__] (dataMap)[__$_3__] (function (key) {
            return value[__$_28__] (key) && (state = recursivelyExecuteDataMaps(dataMap[key], value[key], commonLib_1[__$_4__] (replace, key), track[__$_5__] (key)));
        });
        return state;
    }
    return state;
...
function executeDataMapsPROCEDURE(state, schema, UPDATABLE_object, maps, item) {
    ...
    commonLib_1[__$_7__] (maps || {})[__$_3__] (function (pathTo) {
        ...
        if (commonLib_2[__$_18__] (map)) {
            ...
            }, commonLib_1[__$_2__] ([executedValue], map.args)));
        }
...
function getFrom4DataMap(state, UPDATABLE_object) {
    return function () {
        ...
        if (commonLib_1[__$_31__] .apply(commonLib_1, [UPDATABLE_object[__$_15__] ][__$_5__] (_toConsumableArray(tPath.map(function (path) {
            return normalizePath(path);
        }))))) return commonLib_1[__$_11__] (getFromState.apply(undefined, [state][__$_5__] (tPath)), getFromState.apply(undefined, [UPDATABLE_object[__$_15__] ][__$_5__] (tPath)), { replace: getFromState.apply(undefined, [UPDATABLE_object[__$_8__] ][__$_5__] (tPath)) });
...
function object2PathValues(vals) {
    ...
    fn(vals)[__$_3__] (function (key) {
        ...
        else result.push(commonLib_1[__$_2__] (path, vals[key]));
    });
    if (!result[__$_0__] ) return [commonLib_1[__$_2__] (track[__$_17__] (), {})]; 
    return result;
}
exports.object2PathValues = object2PathValues;
function isNPath(path) {
    return commonLib_1[__$_4__] (path, SymData) === 'nPath';
}
...
function normalizeUpdate(update, state) {
    var path = update[__$_19__] ,
        value = update[__$_10__] ,
        replace = update[__$_8__] ,
        base = update.base,
    ...
    pathes = multiplyPath(pathes, { '*': function _(path) {
            return branchKeys(commonLib_1[__$_4__] (state, path)).join(',');
        } });
...
function string2NUpdate(path) {
    ...
    var value = rest[__$_10__] ,
        replace = rest[__$_8__] ,
...
function isNUpdate(updateItem) {
    return !commonLib_2[__$_1__] (commonLib_1[__$_4__] (updateItem, SymData)) && commonLib_2[__$_9__] (updateItem[SymData]);
}
function multiplyPath(path) {
    ...
    path[__$_3__] (function (value) {
        ...
        if (typeof value == 'string' && ~value[__$_25__] (',')) {
            ...
            return commonLib_1[__$_2__] (result[key], value);
        });
...
var num2string = function num2string(value) {
    return typeof value == 'number' ? value[__$_36__] () : value;
};
function relativePath(base, destination) {
    ...
    return commonLib_1[__$_2__] (result, destination[__$_17__] (i));
...
function flattenPath(path) {
    if (commonLib_2[__$_9__] (path)) {
        var result = [];
        commonLib_1[__$_2__] .apply(commonLib_1, [result][__$_5__] (_toConsumableArray(path.map(flattenPath))));
        return result;
...
function string2path(path) {
    path = path[__$_8__] (symConv(SymData), '/' + symConv(SymData) + '/');
    path = path[__$_8__] (/\/+/g, '/');
    var result = [];
...
function getFromState(state) {
    ...
    return commonLib_1[__$_4__] .apply(commonLib_1, [state][__$_5__] (_toConsumableArray(pathes.map(function (path) {
        return normalizePath(path);
    }))));
}
